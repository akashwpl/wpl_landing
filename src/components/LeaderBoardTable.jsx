...
const LeaderboardTable = ({data, pos}) => {
  ...
  return (
    ...
    //             <th key={index} className={`py-3 leading-[12px] md:px-6 px-1 md:text-[12px] text-[8px] font-normal border-t border-l border-table_border_blue ${widths[key]} min-w-[60px]`}>
    //               {index === 0 ? (
    //                 <>
    //                   <span className="hidden md:inline">{key}</span>
    //                   <span className="md:hidden">#</span>
